  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 h-full w-full max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2">
        <div className="flex flex-col justify-center h-full text-center lg:text-left relative pl-15 sm:pl-18 md:pl-25 lg:pl-30">
          <div className="w-full lg:pr-24 mx-auto max-w-[48rem]">
           ...
           bg-gradient-to-r from-[#1cd8d2] via-[#00bf8f] to-[#302b63] drop-shadow-lg"
            ...
            >
              <a
                className="px-6 py-3 rounded-full font-medium text-lg text-white bg-gradient-to-r from-[#1cd8d2] via-[#00bf8f] 
            to-[#302b63] shadow-lg hover:scale-105 transition-all"
                href=""
              >
                View My Work
              </a>
              <a
                href="/Sharukh_resume_FD_4.1_yrs.pdf"
                download
